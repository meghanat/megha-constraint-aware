...
class NodeResources(TypedDict):
    """
    Typed dictionary class to describe the data format of each worker resource.
...
class OrganizedPartitionResources(TypedDict):
    master_id: str
    partition_id: str
    free_workers: BitArray
    busy_workers: BitArray


class MasterResources(TypedDict):
    master_id: str
    partitions: Dict[str, PartitionResources]


class ConfigFile(TypedDict):
    masters: Dict[str, MasterResources]
